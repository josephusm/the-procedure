...
- Errata and correction history are trace surfaces too. A cold archive needs visible scars: known defects, current errata state, correction surface, source history, and the next release boundary. This is not a warm changelog and not onboarding copy. It should say what is known to be broken or amended, where the correction can be contested, and whether the next version can still be interrupted.
